...
#> # A tibble: 14 x 7
#>    Data  Source `Download Type` `Geographical U~ `Time Periods` `Docs Link`
#>    <chr> <chr>  <chr>           <lgl>            <lgl>          <lgl>      
#>  1 PROD~ <NA>   <NA>            NA               NA             NA         
#>  2 DETER <NA>   <NA>            NA               NA             NA         
#>  3 DEGR~ <NA>   <NA>            NA               NA             NA         
#>  4 COMEX <NA>   <NA>            NA               NA             NA         
#>  5 GDP   <NA>   <NA>            NA               NA             NA         
#>  6 CEMP~ <NA>   <NA>            NA               NA             NA         
#>  7 CENS~ <NA>   <NA>            NA               NA             NA         
#>  8 SIGM~ <NA>   <NA>            NA               NA             NA         
#>  9 PAM   IBGE   API - Sidra     NA               NA             NA         
#> 10 PEVS  IBGE   API - Sidra     NA               NA             NA         
#> 11 PPM   IBGE   API - Sidra     NA               NA             NA         
#> 12 MAPB~ <NA>   <NA>            NA               NA             NA         
